...
let footerElements = {
  baseElement: document.getElementById("site-footer"),
...
let workItems = [
  {
    name: "Project: Hunger Management",
    gitUrl: "https://github.com/StitchCodes/hunger-managment",
    icon: icons.javascript
  },
  {
    name: "Project: Life Multitask Manager",
    gitUrl: "https://github.com/MarioColunga/Life-Multitask-Manager",
    icon: icons.javascript
  },
  {
    name: "Selenium Gigs",
...
function renderLicense(){
  footerElements.license.innerHTML = "<span> MIT License </span>"
}
